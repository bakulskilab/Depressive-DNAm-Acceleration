...
setwd("C:/Users/herongw/Desktop/Kelly_RA/Projects/HW_depressive_DNAm_HRS/Submission/Psychology_aging/Revision_20240323/code")
...
full <- complete %>% 
  ...
  full_join(w13_clocks_smok, by = c("HHID", "PN")) %>% 
...
table(full$HISPANIC, useNA = "always")
full$HISPANIC <- factor(full$HISPANIC, levels =c( 5, 2, 3, 4), 
...
w13_clocks_phy=rand %>% 
  ...
  right_join(complete,by = c("HHID", "PN"))

full_phy=rand %>% 
  select(HHID,PN, all_of(physical_activity)) %>% 
  right_join(full,by = c("HHID", "PN"))
...
library(haven)
library(rlang)
w2016 <- read_dta ("C:/Users/herongw/Desktop/Kelly_RA/database/HRS/Public_Core/w2016/H16B_R.dta")
w2014 <- read_dta ("C:/Users/herongw/Desktop/Kelly_RA/database/HRS/Public_Core/w2016/H14B_R.dta")
w2012 <- read_dta ("C:/Users/herongw/Desktop/Kelly_RA/database/HRS/Public_Core/w2016/H12B_R.dta")
w2010 <- read_dta ("C:/Users/herongw/Desktop/Kelly_RA/database/HRS/Public_Core/w2016/H10B_R.dta")
w2008 <- read_dta ("C:/Users/herongw/Desktop/Kelly_RA/database/HRS/Public_Core/w2016/H08B_R.dta")
w2006 <- read_dta ("C:/Users/herongw/Desktop/Kelly_RA/database/HRS/Public_Core/w2016/H06B_R.dta")
w2004 <- read_dta ("C:/Users/herongw/Desktop/Kelly_RA/database/HRS/Public_Core/w2016/H04B_R.dta")
w2002 <- read_dta ("C:/Users/herongw/Desktop/Kelly_RA/database/HRS/Public_Core/w2016/H02B_R.dta")
w2000 <- read_dta ("C:/Users/herongw/Desktop/Kelly_RA/database/HRS/Public_Core/w2016/H00A_R.dta")
w1998 <- read_dta ("C:/Users/herongw/Desktop/Kelly_RA/database/HRS/Public_Core/w2016/H98A_R.dta")
...
w13_smk_phy_pov = w_pov %>% 
  ...
  right_join(w13_clocks_phy_we, by = c('HHID', "PN")) 
table(w13_smk_phy_pov$poverty, useNA = "always")

full_phy_pov = w_pov %>% 
  select(HHID, PN, poverty) %>% 
  right_join(full_phy, by = c('HHID', "PN")) 
...
table(full$included, useNA = "always")
table(complete$R13ACT, useNA = "always")
table(complete$poverty, useNA = "always")

save(full, file = "full_4018.RData")
save(complete, file = "analytic_sample_3918.RData")


complete_bo = complete %>% 
...
table(complete_bo$race_ethnicity)
complete_bo$race_ethnicity = as.factor(complete_bo$race_ethnicity)
complete_bo$race_ethnicity = relevel(complete_bo$race_ethnicity, ref = "Non-Hispanic White")
save(complete_bo, file = "analytic_bo_3918.RData")

table(complete$R13ACT, complete$depression, useNA = "always")
